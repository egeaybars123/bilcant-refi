                ...
                <div className='LaunchpadProject-Body'>
                  <div className='LaunchpadProject-Body--Top'>
                    <div class="LaunchpadProject-Body--Top--Raised"> 
                      ...
                      <h4 class="LaunchpadProject-Body--Top--Raised--Price">$<span>257,853/400,000</span></h4>
                    
                    </div>
                  </div>
                  <div className='LaunchpadProject-Body--Progress'>
                    <div className='progress_bar_tag'>
                     <p>Bağış</p>

                    </div>
                    <div className='LaunchpadProject-Body--Progress--Background'>
                      <div className='LaunchpadProject-Body--Progress--Background--Percents'>
                       <span>Bağış: 64.46%</span>
                      </div>
                      <div class="seed_indicator indicator"></div>
                    </div>
                  </div>
            ...
            <div className='ProjectsGrid'>
              <div className='LaunchpadProject'>
                ...
                <div className='LaunchpadProject-Body'>
                  <div className='LaunchpadProject-Body--Top'>
                    <div class="LaunchpadProject-Body--Top--Raised"> 
                      <p class="LaunchpadProject-Body--Top--Raised--Para">Toplanan Miktarı</p>
                      <h4 class="LaunchpadProject-Body--Top--Raised--Price">$<span>257,853/400,000</span></h4>
